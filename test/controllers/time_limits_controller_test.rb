...
class TimeLimitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_limit" do
    assert_difference('TimeLimit.count') do
      post time_limits_url, params: { time_limit: { edition_id: @time_limit.edition_id, end_date: @time_limit.end_date, phase_name: @time_limit.phase_name, start_date: @time_limit.start_date } }
    end
  ...
  test "should update time_limit" do
    patch time_limit_url(@time_limit), params: { time_limit: { edition_id: @time_limit.edition_id, end_date: @time_limit.end_date, phase_name: @time_limit.phase_name, start_date: @time_limit.start_date } }
